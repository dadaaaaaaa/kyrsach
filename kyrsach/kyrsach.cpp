...
void M_matrix(double* p1, double* p2, double* p3, double* p4, double* p5, double* p6, double** M_matr, double* local_F, int num_of_area) {
    ...
    local_F[0] = 2 * f[0] + f[1] + f[2]+f[3]+f[4]+f[5];
    local_F[1] =  f[0] + 2 * f[1] + f[2] + f[3] + f[4] + f[5];
    local_F[2] =  f[0] + f[1] + 2 * f[2] + f[3] + f[4] + f[5];
    local_F[3] =  f[0] + f[1] + f[2] + 2 * f[3] + f[4] + f[5];
    local_F[4] =  f[0] + f[1] + f[2] + f[3] + 2 * f[4] + f[5];
    local_F[5] =  f[0] + f[1] + f[2] + f[3] + f[4] + 2 * f[5];
    for (int i = 0; i < 6; i++) {
        cout << local_F[i] << " ";
    }
    cout << endl;
...
void G_matrix(double* p1, double* p2, double* p3, double* p4, double* p5, double* p6, double** G_matr, double gamma, int k) {
...
void local_matrix(int num_of_finit_element, double** local_matr, double* local_F) {
    ...
    int o = finit[num_of_finit_element][3];
    int p = finit[num_of_finit_element][4];
    int r = finit[num_of_finit_element][5];
    ...
    // Заполнение матриц
    M_matrix(point[k], point[l], point[m], point[o], point[p], point[r], M_matr, local_F, finit_in_area[num_of_finit_element]);
    G_matrix(point[k], point[l], point[m], point[o], point[p], point[r], G_matr, gamma_betta[finit_in_area[num_of_finit_element]][0], finit_in_area[num_of_finit_element]);
